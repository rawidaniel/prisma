...
-- CreateIndex
CREATE UNIQUE INDEX "Catgory_name_key" ON "Catgory"("name");

-- CreateIndex
CREATE UNIQUE INDEX "_CatgoryToPost_AB_unique" ON "_CatgoryToPost"("A", "B");

-- CreateIndex
CREATE INDEX "_CatgoryToPost_B_index" ON "_CatgoryToPost"("B");
...
-- AddForeignKey
ALTER TABLE "_CatgoryToPost" ADD CONSTRAINT "_CatgoryToPost_A_fkey" FOREIGN KEY ("A") REFERENCES "Catgory"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CatgoryToPost" ADD CONSTRAINT "_CatgoryToPost_B_fkey" FOREIGN KEY ("B") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
